...
- **Target**: Sale price
- **Accuracy**: R-squared = 0.94, MAPE = 7.2%
...
```bash
git clone https://github.com/rushikiranadiboina/propertyiq-platform.git
...
I am **Rushi Kiran Adiboina**, a Full Stack Developer with over 6 years of experience in designing and developing scalable enterprise applications. My expertise lies in building robust frontend components and distributed backend services across banking, retail, and SaaS environments.

**Project Motivation**:
PropertyIQ was developed to bridge the gap between raw real estate data and actionable investment insights. By leveraging machine learning and geospatial analysis, this platform provides investors with the predictive tools necessary to maximize ROI and minimize market risk.

**Core Competencies**:
- Full-stack development (React, Node.js, Java/Spring Boot)
- Machine learning integration (XGBoost, LightGBM, Python)
- Geospatial data management (PostGIS, Mapbox)
- Cloud Infrastructure & CI/CD (AWS, Azure, Jenkins, Docker)
- Database performance optimization

**Connect**:
- **Email**: rushikiranadiboina@gmail.com
- **LinkedIn**: [linkedin.com/in/rushi-adiboina/](https://www.linkedin.com/in/rushi-adiboina/)
- **GitHub**: [github.com/rushikiranadiboina](https://github.com/rushikiranadiboina)
